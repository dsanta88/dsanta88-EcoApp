...
namespace EcoApp.Server.Data
{
    public class ProveedorDA
    {
        ...
        private IMongoCollection<Proveedor> table;
        ...
        public ProveedorDA()
        {
            ...
            table = database.GetCollection<Proveedor>("Proveedores");
        }
        ...
        public List<Proveedor> ObtenerTodos()
        {
            ...
            try
            {
                list = table.Find(FilterDefinition<Proveedor>.Empty).ToList();
                ...
                list = list.OrderBy(x => x.RazonSocial).ToList();
            }
            catch (Exception ex)
            {
        ...
        public bool IngresarEditar(Proveedor model)
        {
            try
            {
