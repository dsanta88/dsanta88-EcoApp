...
namespace EcoApp.Server.Controllers
{
    ...
    public class ProveedoresController : ControllerBase
    {
        ...
        ProveedorDA datos = new ProveedorDA();
        ...
        public IActionResult Get()
        {
            ...
            try
            {
                List<Proveedor> list = datos.ObtenerTodos();
        ...
        public ActionResult<Proveedor> GetById(string id)
        {
            Response response = new Response();
            try
            {
                Proveedor obj = datos.Obtener(id);
                response.IsSuccessful = true;
                response.Data = obj;
            }
            catch (Exception ex)
        ...
        [HttpPost]
        public IActionResult Add(Proveedor model)
        {
            Response response = new Response();
            try
            {
